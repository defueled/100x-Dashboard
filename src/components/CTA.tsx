...
export function CTA() {
    ...
    return (
        <section className="py-32 px-6 bg-transparent relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10 glass-card rounded-[3rem] p-12 md:p-20 shadow-premium">
                <h2 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">
                    <span className="text-brand-dark">Laiks celt savu </span>
                    <span className="text-gradient-premium">vērtību.</span>
                </h2>
                <p className="text-xl text-brand-dark/70 font-medium mb-10 max-w-2xl mx-auto">
                    Kļūsti par daļu no inovatoru, investoru un tech entuziastu komūnas. Izglītojies un pelni ar AI un Web3.
                </p>
